...
for hand_num in range(1, 1025):  # 测试1024手
    # 重置筹码
...
print(f"\n总结：")
print(f"测试手数：1024")
print(f"误差手数：{error_count}")
print(f"累积误差：{total_error:.2f}BB")
print(f"平均误差：{total_error/1024:.4f}BB/hand")

if error_count == 0:
    print("\n✅ 所有手牌零和正确！")
else:
    print(f"\n✗ 有{error_count}手牌出现零和误差")
